                ...
                <div class="form-row">
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input disabled type="text" name="date" autocomplete="off"
                                   id="date"
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input disabled type="text" name="ref" autocomplete="off"
                                   id="ref"
                                   value="{{$jv->ref}}"
                                   class="form-control   ">
                        </div>
                ...
                <div class="form-row">
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input disabled type="text" name="detail" autocomplete="off"
                                   id="detail"
                                   value="{{$jv->detail}}"
                                   class="form-control   ">
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input disabled name="image_url" id="image_url" type="file"
                ...
                <div class="form-row">
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input disabled type="text" name="party" autocomplete="off"
                                   id="party"
                                   value="{{$jv->party}}"
                                   class="form-control   ">
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input disabled type="text" name="remark" autocomplete="off"
                                   id="remark"
                                   value="{{$jv->remark}}"
                                   class="form-control   ">
                        </div>
...
{{--                        <th>Action</th>--}}
                    ...
                    @foreach($jvItems as $jvItem)
                        <tr>
                            ...
                            <td class="p-0">
                                <select disabled class="select2 form-control p-0 m-0 row_acc_head_id" style="width: 100%"
                                        name="state">
                            ...
                            <td class="p-0 "><input disabled class="form-control p-0 m-0 b-radius-0 text-center row_debit"
                                                    value="{{$jvItem->debit}}" type="number"></td>
                            <td class="p-0 "><input disabled class="form-control p-0 m-0 b-radius-0 text-center row_credit"
...
{{--                            <button id="add_new_item_btn" disabled class="btn btn-primary">Add New Row</button>--}}
{{--                            <button id="save_btn" disabled class="btn btn-success">Save Update</button>--}}
{{--                        </td>--}}
{{--                    </tr>--}}
                    </tfoot>
                </table>
